...
DEFAULT_UPLOAD_PATH = 'uploads/%Y/%m/%d'
UPLOAD_PATH = getattr(settings, 'DRF_CHUNKED_UPLOAD_PATH', DEFAULT_UPLOAD_PATH)

DEFAULT_CHUNKED_UPLOAD_PATH = 'chunked_uploads/%Y/%m/%d'
CHUNKED_UPLOAD_PATH = getattr(settings, 'DEFAULT_CHUNKED_UPLOAD_PATH', DEFAULT_CHUNKED_UPLOAD_PATH)
...
ABSTRACT_MODEL = getattr(settings, 'DRF_CHUNKED_UPLOAD_ABSTRACT_MODEL', False)
